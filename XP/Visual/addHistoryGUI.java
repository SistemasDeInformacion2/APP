...
public class addHistoryGUI extends javax.swing.JFrame 
{
    ...
    private void addHistoria( java.awt.event.ActionEvent evt )
    {
        ...
        String descripcion = historia.getText();
        int importancia_value = (int)importancia.getValue();
        
        historia_para_subir = new HistoriaUsuario( nombre, descripcion, importancia_value );
        puenteHU.addHistoria( historia_para_subir );
